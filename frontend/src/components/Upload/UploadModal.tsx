...
const ERROR_MAP = new Map([
  ...
  ['rejected_file_type', 'Arquivo não suportado.'],
  ['rejected_max_files', 'Apenas um arquivo é permitido.'],
  ['error_file_size', 'O arquivo excede o limite de tamanho (30 MB).'],
  ['error_upload_params', 'Ocorreu um erro desconhecido.'],
]);
...
class UploadModal extends React.Component<Props, State> {
  ...
  render(): JSX.Element {
    ...
    const modalTitle = detailsStep ? 'Preencha os detalhes' : 'Carregar música ou pesquisar vídeo do YouTube';
    const primaryText = detailsStep ? 'Finalizar' : 'Próximo';
