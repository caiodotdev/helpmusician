...
import { AccompShortBadge, BassBadge, DrumsBadge, MetronomeBadge, PianoBadge, VocalsBadge } from '../Badges';
...
const VolumeUI = (props: Props): JSX.Element => {
  ...
  } else if (props.id === 'metronome') {
    badge = <MetronomeBadge className="vol-badge" />;
  }
