...
import { AccompShortBadge, BassBadge, DrumsBadge, OriginalBadge, VocalsBadge, PianoBadge } from '../Badges';
  ...
  render(): JSX.Element | null {
    ...
    return (
      ...
      <ReactJkMusicPlayer
        ...
        locale={{ playListsText: 'Tocando agora' } as ReactJkMusicPlayerCustomLocale}
        spaceBar={true}
