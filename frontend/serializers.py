...
class SourceFileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SourceFile
        fields = ('id', 'file', 'file_url', 'is_youtube', 'youtube_link',
                  'youtube_fetch_task')
...
class LiteDynamicMixSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'source_track', 'separator', 'extra_info', 'artist',
                  'title', 'vocals_url', 'piano_url', 'other_url', 'bass_url',
...
class LiteStaticMixSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StaticMix
        fields = ('id', 'source_track', 'separator', 'extra_info', 'artist',
                  'title', 'vocals', 'piano', 'drums', 'bass', 'other', 'status', 'url',
...
class FullStaticMixSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        :param data: Request data
        """
        all_checked = data['vocals'] and data['piano'] and data['drums'] and data[
            'bass'] and data['other']
        none_checked = not (data['vocals'] or data['piano'] or data['drums'] or data['bass']
                            or data['other'])
        if all_checked:
...
class YTSourceTrackSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SourceTrack
        fields = ['id', 'user', 'youtube_link', 'artist', 'title']
