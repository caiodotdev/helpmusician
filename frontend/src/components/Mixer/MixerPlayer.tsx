    ...
    return (
      <div>
        ...
        <Alert className="mt-5" variant="info" style={{ fontSize: '0.9em' }}>
          <p className="mb-0">
            <b>Silenciar/ativar instrumentos: </b>
            <kbd>1</kbd>
            <kbd>2</kbd>
            <kbd>3</kbd>
            <kbd>4</kbd>
            ...
            <kbd>T</kbd>
            <kbd>Y</kbd>
            &nbsp;(Segure <kbd>Ctrl/Cmd/Shift</kbd>para solo/unsolo multiplos instrumentos)
          </p>
        </Alert>
      </div>
    );
